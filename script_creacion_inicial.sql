...
BEGIN
		INSERT INTO GESTIONATE.agente (nombre, apellido, numero_doc, tipo_doc, fecha_registro, fecha_nacimiento, telefono, mail)
		SELECT DISTINCT AGENTE_NOMBRE, AGENTE_APELLIDO, AGENTE_DNI, 'DNI', AGENTE_FECHA_REGISTRO, AGENTE_FECHA_NAC, AGENTE_TELEFONO, AGENTE_MAIL FROM gd_esquema.Maestra WHERE AGENTE_DNI IS NOT NULL
END
GO
...
BEGIN
    INSERT INTO [GESTIONATE].pago_venta
               ...
               SELECT PAGO_VENTA_IMPORTE, PAGO_VENTA_COTIZACION, GESTIONATE.OBTENER_MONEDA(PAGO_VENTA_MONEDA),GESTIONATE.OBTENER_MEDIO_DE_PAGO(PAGO_VENTA_MEDIO_PAGO)
