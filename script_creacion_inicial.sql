...
BEGIN
	    INSERT INTO GESTIONATE.localidad (nombre, codigo_provincia)
			SELECT DISTINCT INMUEBLE_LOCALIDAD, GESTIONATE.OBTENER_PROVINCIA(INMUEBLE_PROVINCIA) FROM gd_esquema.Maestra WHERE INMUEBLE_LOCALIDAD IS NOT NULL
			UNION
			SELECT DISTINCT SUCURSAL_LOCALIDAD, GESTIONATE.OBTENER_PROVINCIA(SUCURSAL_PROVINCIA) FROM gd_esquema.Maestra WHERE SUCURSAL_LOCALIDAD IS NOT NULL
END
GO 
...
BEGIN
	...
	SELECT DISTINCT SUCURSAL_CODIGO, SUCURSAL_NOMBRE, GESTIONATE.OBTENER_DIRECCION(SUCURSAL_DIRECCION), SUCURSAL_TELEFONO FROM gd_esquema.Maestra WHERE SUCURSAL_CODIGO IS NOT NULL
END
GO
...
BEGIN
		...
		SELECT DISTINCT AGENTE_NOMBRE, AGENTE_APELLIDO, AGENTE_DNI, 'DNI', AGENTE_FECHA_REGISTRO, AGENTE_FECHA_NAC, AGENTE_TELEFONO, AGENTE_MAIL, GESTIONATE.OBTENER_SUCURSAL(SUCURSAL_CODIGO) FROM gd_esquema.Maestra WHERE AGENTE_DNI IS NOT NULL
END
GO
...
BEGIN
	...
	SELECT DISTINCT INMUEBLE_CODIGO, INMUEBLE_NOMBRE, GESTIONATE.OBTENER_TIPO_INMUEBLE(INMUEBLE_TIPO_INMUEBLE), INMUEBLE_DESCRIPCION, GESTIONATE.OBTENER_PROPIETARIO(PROPIETARIO_DNI), GESTIONATE.OBTENER_DIRECCION(INMUEBLE_DIRECCION), GESTIONATE.OBTENER_AMBIENTE(INMUEBLE_CANT_AMBIENTES), INMUEBLE_SUPERFICIETOTAL, GESTIONATE.OBTENER_DISPOSICION(INMUEBLE_DISPOSICION), GESTIONATE.OBTENER_ORIENTACION(INMUEBLE_ORIENTACION), GESTIONATE.OBTENER_ESTADO_INMUEBLE(INMUEBLE_ESTADO), GESTIONATE.OBTENER_ANTIGUEDAD(INMUEBLE_ANTIGUEDAD), INMUEBLE_EXPESAS FROM gd_esquema.Maestra WHERE INMUEBLE_CODIGO IS NOT NULL
END
GO
...
BEGIN
	...
	ANUNCIO_FECHA_PUBLICACION, ANUNCIO_FECHA_FINALIZACION, ANUNCIO_COSTO_ANUNCIO FROM gd_esquema.Maestra WHERE ANUNCIO_CODIGO IS NOT NULL
END
GO
...
BEGIN
    INSERT INTO [GESTIONATE].pago_venta
               ...
               SELECT GESTIONATE.OBTENER_VENTA(VENTA_CODIGO), PAGO_VENTA_IMPORTE, PAGO_VENTA_COTIZACION, GESTIONATE.OBTENER_MONEDA(PAGO_VENTA_MONEDA),GESTIONATE.OBTENER_MEDIO_DE_PAGO(PAGO_VENTA_MEDIO_PAGO)
...
BEGIN
    ...
    SELECT DISTINCT GESTIONATE.OBTENER_ALQUILER(ALQUILER_CODIGO), DETALLE_ALQ_NRO_PERIODO_INI, DETALLE_ALQ_NRO_PERIODO_FIN, DETALLE_ALQ_PRECIO
...
CREATE INDEX ind_inmueble ON GESTIONATE.inmueble (codigo_inmueble);
CREATE INDEX ind_anuncio ON GESTIONATE.anuncio (codigo_anuncio);
CREATE INDEX ind_alquiler ON GESTIONATE.alquiler (codigo_alquiler);
CREATE INDEX ind_sucursal ON GESTIONATE.sucursal (codigo_sucursal);
CREATE INDEX ind_venta ON GESTIONATE.venta (codigo_venta);
GO
